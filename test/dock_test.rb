...
class DockTest < Minitest::Test
  ...
  def test_returning_boat_takes_renters_off_list
    dock = Dock.new("The Rowing Dock", 3)
    kayak_1 = Boat.new(:kayak, 20)
    kayak_2 = Boat.new(:kayak, 20)
    canoe = Boat.new(:canoe, 25)
    ...
    assert_equal [[canoe, patrick]], dock.rented_list
  end

  def test_returning_boat_adds_renters_to_returned_list
    dock = Dock.new("The Rowing Dock", 3)
    kayak_1 = Boat.new(:kayak, 20)
    kayak_2 = Boat.new(:kayak, 20)
    canoe = Boat.new(:canoe, 25)
    ...
    assert_equal [[kayak_1, patrick]], dock.returned_list
  end

  def test_can_add_up_revenue
    dock = Dock.new("The Rowing Dock", 3)
    kayak_1 = Boat.new(:kayak, 20)
    kayak_2 = Boat.new(:kayak, 20)
    canoe = Boat.new(:canoe, 25)
  ...
  def test_can_charge_per_person
    skip
    dock = Dock.new("The Rowing Dock", 3)
    kayak_1 = Boat.new(:kayak, 20)
    kayak_2 = Boat.new(:kayak, 20)
